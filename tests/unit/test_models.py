...
def test_get_stock_data_success(test_client_with_app_context, mock_requests_get_success, new_stock):
    """
...
def test_get_stock_data_success_two_calls(test_client_with_app_context, mock_requests_get_success, new_stock):
    """
    GIVEN a Flask application and a monkeypatched version of requests.get()
    WHEN the HTTP response is set to successful
    THEN check that the stock data is updated
